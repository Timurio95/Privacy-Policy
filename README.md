...
Developer Timur Panteleev built ```Snake: UFO defence``` as an Ad Supported app.
```Snake: UFO defence``` is provided by at no cost and is intended for use as is.
...
alonecreatorstudio(at)gmail(dot)com
